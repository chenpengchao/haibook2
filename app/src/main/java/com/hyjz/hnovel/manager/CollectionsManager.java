...
// */
//package com.hyjz.hnovel.manager;
//
...
//     * @return
//     */
//    public List<BookRecommend.BookShelfList> getCollectionList() {
//        List<BookRecommend.BookShelfList> list = (ArrayList<BookRecommend.BookShelfList>) ACache.get(new File(Constant.PATH_COLLECT)).getAsObject("collection");
