...
import com.hyjz.hnovel.ireader.model.gen.DaoSession;
import com.hyjz.hnovel.ireader.model.gen.DownloadTaskBeanDao;
import com.hyjz.hnovel.ireader.utils.BookManager;
import com.hyjz.hnovel.ireader.utils.Constant;
import com.hyjz.hnovel.ireader.utils.FileUtils;
import com.hyjz.hnovel.ireader.utils.IOUtils;
...
public class BookRepository {
    ...
    //获取书籍列表
    public Observable<List<BookChapterBean>> getBookChaptersInRx(String bookId){
        return Observable.create(new Observable.OnSubscribe<List<BookChapterBean>>(){
            @Override
            public void call(Subscriber<? super List<BookChapterBean>> subscriber) {
    ...
    /************************************************************/
    public Observable<Void> deleteCollBookInRx(CollBookBean bean) {
