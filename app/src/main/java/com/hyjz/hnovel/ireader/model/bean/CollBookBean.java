...
import com.hyjz.hnovel.ireader.utils.StringUtils;
...
public class CollBookBean implements Parcelable{
    ...
    public String getTitle() {
        return StringUtils.convertCC(title, MyApp.getContext());
    }
    ...
    public String getAuthor() {
        return StringUtils.convertCC(author, MyApp.getContext());
    }
    ...
    public String getShortIntro() {
        return StringUtils.convertCC(shortIntro, MyApp.getContext());
    }
    ...
    public String getCover() {
        return StringUtils.convertCC(cover, MyApp.getContext());
    }
    ...
    public String getUpdated() {
        return StringUtils.convertCC(updated, MyApp.getContext());
    }
    ...
    public String getLastChapter() {
        return StringUtils.convertCC(lastChapter, MyApp.getContext());
    }
    ...
    public String getLastRead() {
        return StringUtils.convertCC(lastRead, MyApp.getContext());
    }
