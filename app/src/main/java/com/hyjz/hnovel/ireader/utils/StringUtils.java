...
import com.hyjz.hnovel.utils.ChineseConverter;
import com.hyjz.hnovel.utils.ConversionType;
...
import static com.hyjz.hnovel.ireader.model.local.ReadSettingManager.SHARED_READ_CONVERT_TYPE;
...
public class StringUtils {
    ...
    public static String getString(@StringRes int id, Object... formatArgs){
        return MyApp.getContext().getResources().getString(id,formatArgs);
    }
