...
public class CashwithdrawalAc extends BaseActivity<CashwithdrawPresenter> implements View.OnClickListener, CashwithdrawView {
    ...
    TextView title;
    //余额显示
    @BindView(R.id.ac_cashwithdraw_remainder)
    TextView ac_cashwithdraw_remainder;
    //输入兑换金额
    @BindView(R.id.ac_cashwithdraw_et)
    EditText ac_cashwithdraw_et;
    //确认提现按钮
    @BindView(R.id.ac_cashwithdraw_tv_confirm)
    TextView ac_cashwithdraw_tv_confirm;
    //设置支付宝账号
    @BindView(R.id.ac_cashwithdraw_tv_setalipay)
    TextView ac_cashwithdraw_tv_setalipay;
    //填写支付宝账号的弹窗
    private PopupWindow popupWindow;
    //填写姓名
//    @BindView(R.id.et_pop_name)
    EditText et_pop_name;
    //填写支付宝账号
//    @BindView(R.id.et_alipay)
    EditText et_alipay;
    //再次填写支付宝账号
//    @BindView(R.id.et_alipay_second)
    EditText et_alipay_second;
    //取消按钮
//    @BindView(R.id.pop_tv_cancel)
    TextView pop_tv_cancel;
    //确认按钮
//    @BindView(R.id.pop_tv_confirm)
