...
public class GoldTOBookCoinAc extends BaseActivity<GoldToBookCoinPresenter> implements GoldToBookCoinView {
    ...
    TextView title;
    //显示金币个数
    @BindView(R.id.tv_show_gold_coin)
    TextView tv_show_gold_coin;
    //四个选择按钮
    @BindView(R.id.ll_book_coin_1)
    LinearLayout ll_book_coin_1;
    @BindView(R.id.ll_book_coin_2)
    LinearLayout ll_book_coin_2;
    @BindView(R.id.ll_book_coin_3)
    LinearLayout ll_book_coin_3;
    @BindView(R.id.ll_book_coin_4)
    LinearLayout ll_book_coin_4;

    @BindView(R.id.tv_book_coin_1)
    TextView tv_book_coin_1;
    @BindView(R.id.tv_book_coin_2)
    TextView tv_book_coin_2;
    @BindView(R.id.tv_book_coin_3)
    TextView tv_book_coin_3;
    @BindView(R.id.tv_book_coin_4)
    TextView tv_book_coin_4;

    @BindView(R.id.tv_gold_coin_1)
    TextView tv_gold_coin_1;
    @BindView(R.id.tv_gold_coin_2)
    TextView tv_gold_coin_2;
    @BindView(R.id.tv_gold_coin_3)
    TextView tv_gold_coin_3;
    @BindView(R.id.tv_gold_coin_4)
    TextView tv_gold_coin_4;
    //确认兑换按钮
    @BindView(R.id.tv_gold_tobookcoin_confirm)
