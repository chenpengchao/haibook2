 ...
 */
package com.hyjz.hnovel.readview;
...
public class PageFactory {
    ...
    private List<ChapterBeanList.ChapterBean> chaptersList;
    ...
    public PageFactory(Context context, String bookId, List<ChapterBeanList.ChapterBean> chaptersList) {
    ...
    public PageFactory(Context context, int width, int height, int fontSize, String bookId,
                       List<ChapterBeanList.ChapterBean> chaptersList) {
        mContext = context;
        mWidth = width;
        mHeight = height;
        mFontSize = fontSize;
        ...
        mTitlePaint.setColor(ContextCompat.getColor(MyApp.getInstance(), R.color.chapter_title_day));
    ...
    public synchronized void onDraw(Canvas canvas) {
        ...
        if (mLines.size() > 0) {
            ...
            // 绘制标题
            canvas.drawText(chaptersList.get(currentChapter - 1).getChapterTitle(), marginWidth, y, mTitlePaint);
