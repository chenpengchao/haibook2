...
import com.hyjz.hnovel.utils.ToastUtils;
...
public abstract class BaseReadView extends View {
    ...
    public BaseReadView(Context context, String bookId, List<ChapterBeanList.ChapterBean> chaptersList,
    ...
    public synchronized void init(int theme) {
        if (!isPrepared) {
            try {
                ...
                LogUtil.i("上次阅读位置：chapter=" + pos[0] + " startPos=" + pos[1] + " endPos=" + pos[2]);
                if (ret == 0) {
